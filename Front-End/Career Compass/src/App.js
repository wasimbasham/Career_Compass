      ...
      <Container>
        <Row className="justify-content-md-center">
          ...
          <Switch>
            ...
            <Route path="/BillerRegister" exact component={BillerRegister} />
            {/* <Route path="/BillerProvider" exact component={BillerProvider} /> */}
            {/* <Route path="/BillerStatement" exact component={BillerStatement} /> */}
          </Switch>
        </Row>
      </Container>
    </Router>
